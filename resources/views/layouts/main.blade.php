    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary navbar-blur">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <div class="d-flex">
            <!-- Keep as direct links for now -->
            <button class="btn btn-light btn-sm me-2" onclick="window.location.href='{{ route('login') }}'">Login</button>
            <button class="btn btn-outline-light btn-sm" onclick="window.location.href='{{ route('register') }}'">Register</button>
          </div>
        </div>
      </div>
    </nav>
