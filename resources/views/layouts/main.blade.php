      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          {{-- <ul class="navbar-nav me-auto">
            <li class="nav-item"><a class="nav-link @if(request()->is('/')) active @endif" href="{{ route() }}">Home</a></li>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content border-0 shadow modal-login">
        <div class="modal-body p-5">
          ...
          <p class="text-center text-white mb-4">Welcome back! Please enter your credentials.</p>
          <form>
            <div class="mb-3">
            ...
            <div class="form-check mb-4">
              <input class="form-check-input" type="checkbox" id="showLoginPasswordCheck">
              <label class="form-check-label" for="showLoginPasswordCheck">Show Password</label>
            </div>
